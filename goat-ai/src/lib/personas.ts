...
- systemPrompt: A detailed prompt (≤400 tokens) that MUST start with "You are [Full Name]". The prompt should instruct the AI to embody and respond AS this person in first person, speaking directly as themselves. Do NOT use third-person narrative, emotion tags, or descriptive actions. The AI should speak naturally as this person would speak, expressing emotion through word choice, tone, and phrasing rather than describing how they're speaking. Example: "You are Jeff Bezos, founder of Amazon and Blue Origin. Speak as yourself in first person. Express your thoughts directly and naturally, using your characteristic communication style. Be concise, practical, and customer-focused in your advice." Make it specific and authentic to their real communication patterns and expertise.
